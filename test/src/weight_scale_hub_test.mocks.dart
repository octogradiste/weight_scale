...
import 'package:weight_scale/ble.dart' as _i2;
...
class MockBleManager extends _i1.Mock implements _i2.BleManager {
  ...
  @override
  _i3.Future<Set<_i2.BleDevice>> get connectedDevices =>
      (super.noSuchMethod(Invocation.getter(#connectedDevices),
              returnValue: Future<Set<_i2.BleDevice>>.value(<_i2.BleDevice>{}))
  ...
  _i3.Future<void> startScan(
      ...
      (super.noSuchMethod(
          Invocation.method(
              #startScan, [], {#withServices: withServices, #timeout: timeout}),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
